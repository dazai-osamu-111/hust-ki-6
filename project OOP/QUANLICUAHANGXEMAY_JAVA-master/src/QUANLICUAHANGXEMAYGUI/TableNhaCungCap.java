 ...
 * @author duy
 */
public class TableNhaCungCap extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TableNhaCungCap
     */
    public TableNhaCungCap() {
        initComponents();
        Biding();
    ...
    void timkiem() {
        ...
        //  
        listNhaCungCap = NhaCungCapdll.getALL("", "dbo.fuChuyenCoDauThanhKhongDau(TenNhaCC) like N'%'+dbo.fuChuyenCoDauThanhKhongDau('" + txtsearch.getText() + "')+'%'", "");
    ...
    public void Biding() {
        ...
        Vector data = new Vector();
            listNhaCungCap = NhaCungCapdll.getALL(" 5 ", " [MaNhaCC] not in (SELECT top "+(trang*5-5) +" [MaNhaCC] from dbo.NhaCungCap )", "");
        for (NhaCungCap kh : listNhaCungCap) {
            Vector row = new Vector();
            row.add(kh.getMaNhaCungCap());
            row.add(kh.getTenNhaCungCap());
...
//            PhieuNhapGUI.cbbmanhanhacungcap.setSelectedItem(listNhaCungCap.get(row_table).getMaNhaCungCap().toString().trim());
            ...
            model.addElement(listNhaCungCap.get(row_table).getMaNhaCungCap().toString().trim());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableNhaCungCap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TableNhaCungCap().setVisible(true);
            }
        });
    }
